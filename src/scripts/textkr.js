...
export const KOREAN_PHRASES_API = [
    ...
    "저 빛이 더 밝아질수록 내 그림자도 길어자는데", "안돼 그만해 꽃은 넣어둬 그냥 좀 바람이 불게 놔줘",
    "눈치 없이 밖을 나가는 걸까", "완벽한 하루를 사실 너와 걸을 수 있다면 얼마나 좋을",
    "뭐라 해도 나에겐 삶의", "날 바라보는 눈빛이 말해주잖아", "아름다운 그녀는 아직까지 누구와 진실 된 사랑의 맛을 본적인",
    "끝나지 않을 이야기가 되어 빛날 거야", "같은 꿈 속을 함께 거닐 테니까", "달아나고 싶어 저 멀리",
    "또 취하게 해 깊이", "기억 속의 모든 날이 울고 웃던 시간들이 지금의 우리를 다 만들어 준거라", "우린 지금처럼 하나니까",
    "무엇을 원해 원해 뭐든 다 줄게", "같이 놀러 갈래", "이런 악몽이라면 영영 깨지 않을 게", "우리는 오렌지 태양 아레 그림자 없이 함께 춤을 춰",
    ...
    "동해 물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세. 무궁화 삼천리 화려 강산 대한 사람, 대한으로 길이 보전하세. 남산 위에 저 소나무, 철갑을 두른 듯 바람 서리 불변함은 우리 기상일세. 무궁화 삼천리 화려 강산 대한 사람, 대한으로 길이 보전하세. 가을 하늘 공활한데 높고 구름없이 밝은 달은 우리 가슴 일편단심일세. 무궁화 삼천리 화려 강산 대한사람, 대한으로 길이 보전하세. 이 기상과 이 맘으로 충성을 다하여 괴로우나 즐거우나 나라 사랑하세. 무궁화 삼천리 화려 강산 대한 사람, 대한으로 길이 보전하세.",
    ...
    "인생은 지긋지긋한 일의 반복이 아니라 지긋지긋한 일의 연속이다", "아주 많은 실수를 저지른 것이 아니라면, 옳은 선택 몇 개만으로도 인생은 성공할 수 있다"
]
